namespace SummaRace.Constants
{
    ...
    public static class AudioKeys
    {
        ...
        // en-US-AvaMultilingualNeural, --rate=-15% since 2026-09-15; was en-PH-RosaNeural -10%), through the SAME AudioSource, and behind the
        ...
        ///   python -m edge_tts --voice en-US-AvaMultilingualNeural --rate=-15% -f &lt;text&gt; --write-media vo_race_briefing.mp3
